...
function evalueerNegatief(formid) {
	...
	var velden = "<tr id='new_row_"+formid+"'><td>"+vertaling+":</td><td><textarea name='opmerking' cols='50' rows='8'/></textarea></td><td class='img'><img alt='doorgeven' class='bewerk klik' title='Deze opmerking doorsturen' src='images/icon_accept.gif' onclick=\"zendOpmerking("+formid+");\"/></td><td class='img'><img alt='Cancel' class='bewerk klik' title='Annuleer' src='images/action_stop.gif' onclick=\"annuleer("+formid+");\"/></td></tr>";
