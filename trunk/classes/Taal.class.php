...
class Taal {
	...
	private $messages = array(
			...
			'en' => array('titel' => 'Online Repairform',
						  ...
						  'herstelformulieren_te_evalueren_disclaimer' => "You still have some repairs that need to be evaluated. We need you to do this because it allows us to check if the repairs were done correctly, and build statistics on these kind of problems.",
