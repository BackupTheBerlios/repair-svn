...
class Taal {
	...
	private $messages = array(
			'nl' => array('titel' => 'Online Herstelformulier',
						  ...
						  'disclaimer_evaluatie_melding' => 'Deze herstelformulieren werden uitgevoerd maar moeten nog ge&#235valueerd worden. Klik op de duim omhoog om de herstelling aan te duiden als uitgevoerd en hersteld. Klik op de duim omlaag om aan te geven dat de herstelling niet opgelost is (of maar gedeeltelijk), en eventueel een extra opmerking toe te voegen. Let op: je keuze is finaal en onomkeerbaar!',
						  'datum' => 'Datum',
						  'inhoud' => 'Inhoud',
						  'afmelden' => 'Afmelden',
						  'aanmelden' => 'Aanmelden',
			...
			'en' => array('titel' => 'Online Repairform',
						  ...
						  'disclaimer_evaluatie_melding' => 'These defects were passed on but they do still need to be evaluated. Click on the thumbs up icon if this defect was repaired correctly. Click on the thumbs down icon if it wasn\'t repaired corectly and you would like to add a comment. Watch out: your choice is final and irreversible!',
						  'datum' => 'Date',
						  'inhoud' => 'Content',
						  'afmelden' => 'Logout',
						  'aanmelden' => 'Login',
