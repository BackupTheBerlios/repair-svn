...
class Taal {
	...
	private $messages = array(
			'nl' => array('titel' => 'Online Herstelformulier',
						  ...
						  'herstelformulieren_te_evalueren_disclaimer' => "E&#233n van uw herstellingen werd een eindje geleden uitgevoerd door de herstellingsdienst. Wij hebben echter nog niet gehoord van u of deze herstelling goed gebeurd is, of dat u nog opmerkingen heeft. Met deze informatie kunnen we onze diensten verbeteren.",
						  ...
						  'succes_melding_bewerkt' => "<h1>Succes</h1><p>Uw melding werd aangepast. Klik <a href='studentMeldingEvalueren.php'>hier</a> om terug te keren naar het evaluatie scherm, of <a href='studentOverzicht.php'>hier</a> om terug te keren naar het overzicht.</p>",
			...
			'en' => array('titel' => 'Online Repairform',
						  ...
						  'succes_melding_bewerkt' => "<h1>Success</h1><p>Your report was editted. Click <a href='studentMeldingEvalueren.php'>here</a> to return to the evaluation list, or <a href='studentOverzicht.php'>here</a> to return to the main screen.</p>",
