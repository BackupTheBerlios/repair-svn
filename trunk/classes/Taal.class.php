...
class Taal {
	...
	private $messages = array(
			'nl' => array('titel' => 'Online Herstelformulier',
						  ...
						  'aanmelden' => 'Aanmelden',
						  'overzicht' => 'Overzicht',
						  'welkom_overzicht_naam' => 'Welkom %1$s, op deze pagina kunt u een overzicht vinden van de reeds ingediende herstelformulieren. Indien een herstelformulier nog niet bekeken is door de homemanager, kan je het nog aanpassen (klik op <img src="images/page_edit.gif"/>) of verwijderen (klik op <img src="images/page_delete.gif"/>).',
