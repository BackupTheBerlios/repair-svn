...
class Auth{	
			        	...
			        	if((time()-$time) < self::$threshold){//is het geen oude key?
			        		...
			        		if($id!=0){//als dat zo is maak zijn object aan
			        			...
			        			if(isset($data[home]))
			        				...
			        				throw new Exception("Deze applicatie is enkel toegankelijk voor bewoners van een studentehome. ".$data['voornaam']." ".$data['achternaam']." komt niet voor in de databank met homebewoners.");
			        		}
	...
	public function getLoginURL(){
		...
		return "https://webauth.ugent.be/?relogin=1&aid=".self::$aid ."&amp;url=$protocol".$_SERVER['SERVER_NAME'].$_SERVER['SCRIPT_NAME'];
	}
